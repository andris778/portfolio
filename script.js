...
const translations = {
  lv: {
    ...
    project_classroom_badge: "Komandas darbs",
    project_classroom_desc: "Laravel tīmekļa lietotne, veidota kopā ar kursa biedru Didzi. Darbs ar MySQL datu bāzi, migrācijām un Blade skatiem.",
  ...
  en: {
    ...
    project_classroom_badge: "Team project",
    project_classroom_desc: "A Laravel web application built together with my classmate Didzis. Work with a MySQL database, migrations and Blade views.",
  ...
  ru: {
    ...
    project_classroom_badge: "Командный проект",
    project_classroom_desc: "Веб-приложение на Laravel, созданное вместе с однокурсником Дидзисом. Работа с базой данных MySQL, миграциями и представлениями Blade.",
